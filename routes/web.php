...
return [
    ...
    ['GET',  '/admin/users',             ['AdminController', 'users'], [AuthMiddleware::class, RoleMiddleware::class . ':administrateur']],
    ['GET',  '/admin/stats',             ['AdminController', 'stats'], [AuthMiddleware::class, RoleMiddleware::class . ':administrateur']],
    ['GET',  '/admin/employes/create',   ['AdminController', 'createEmployeeForm'], [AuthMiddleware::class, RoleMiddleware::class . ':administrateur']],
    ['POST', '/admin/employes/create',   ['AdminController', 'createEmployee'], [CsrfMiddleware::class, AuthMiddleware::class, RoleMiddleware::class . ':administrateur']],
    ['POST', '/admin/utilisateurs/{id:\d+}/suspendre', ['AdminController', 'suspendUser'], [CsrfMiddleware::class, AuthMiddleware::class, RoleMiddleware::class . ':administrateur']],
    ['POST', '/admin/users/suspend',     ['AdminController', 'suspendUser'], [CsrfMiddleware::class, AuthMiddleware::class, RoleMiddleware::class . ':administrateur']],
